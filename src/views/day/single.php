...
>
	...
	<div class="tribe-events-day-event-content">
		...
		<!-- Event Title -->
		<?php do_action( $prefix . '_single_before_the_event_title' ) ?>
		<h2 class="tribe-events-list-event-title summary ">
			<a class="url" href="<?php echo esc_url( tribe_get_event_link() ); ?>" title="<?php the_title_attribute() ?>" rel="bookmark">
				<?php the_title() ?>
			</a>
		</h2>
		<?php do_action( $prefix . '_single_after_the_event_title' ) ?>

		<!-- Event Meta -->
		<?php do_action( $prefix . '_single_before_the_meta' ) ?>
		...
		<?php if ( tribe_get_cost() ) : ?>
			<div class="tribe-events-event-cost">
				...
				do_action( $prefix . '_single_inside_cost' )
				?>
			</div>
		<?php endif; ?>

		<?php do_action( $prefix . '_single_after_the_meta' ) ?>
